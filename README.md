...
For development (local machine) I created environment variable called "DATABASE_URL" for MySql connection string and "SecredKey" for JWT encryption part in Program.cs. 
